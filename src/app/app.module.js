(function() {
  ...
  angular
    .module('boisestate', ['ngMaterial', 'boisestate.core', 'boisestate.compare', 'boisestate.connect', 'boisestate.degree', 'boisestate.home', 'boisestate.services', 'templates-app'])
    .config(AppConfig)
  ;
